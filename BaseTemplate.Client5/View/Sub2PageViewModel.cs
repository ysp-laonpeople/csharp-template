...
{
    public class Sub2PageViewModel : BaseViewModel, IBaseViewModel
    {
        public Sub2PageViewModel(string contractID, IMessageBus messageContract, IDialogService dialogContract)
        : base()
        {
